...
export default function Sidebar() {
  ...
  return (
    <div className="w-70 self-stretch rounded-2xl p-4 flex flex-col gap-1 bg-clio-glass border border-clio-glass-border">
      ...
      <div className="flex items-center justify-between px-3 pb-1 mt-8">
      ...
      <div className="rounded-2xl p-3.5 bg-glass-inset border border-clio-glass-border mt-8">
